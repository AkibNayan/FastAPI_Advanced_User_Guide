...
# openssl rand -hex 32
SECRET_KEY = "4ec334c17f1900abef10bc0a04213ad4399dd0c46360b4a7ee0acbe67947a822"
ALGORTHM = "HS256"
...
def create_access_token(data: dict, expires_delta: timedelta | None = None):
    ...
    encoded_jwt = jwt.encode(to_encode, SECRET_KEY, algorithm=ALGORTHM)
    return encoded_jwt
...
async def get_current_user(
    ...
    if security_scopes.scopes:
        authenticate_value = f"Bearer scopre={security_scopes.scope_str}"
    else:
